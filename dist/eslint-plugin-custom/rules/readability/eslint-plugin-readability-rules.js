...
const createRule = ESLintUtils.RuleCreator((name) => `https://github.com/your-org/eslint-plugin-custom/blob/main/docs/${name}.md`);
/**
...
export const noNestedTernary = createRule({
    ...
    meta: {
        type: 'suggestion',
        docs: {
            description: 'Disallow nested ternary operators. Nested ternaries are difficult to read and understand. Use if-else statements or extract the logic into a well-named function for better code clarity.',
            url: 'https://github.com/vertex-era/eslint-rules/blob/main/docs/rules/no-nested-ternary.md',
        },
        messages: {
            noNestedTernary: 'Nested ternary operators reduce code readability. Refactor to if-else statements or extract to a descriptive function (e.g., getStatusColor, calculateDiscount).',
        },
        schema: [],
    },
    defaultOptions: [],
...
//# sourceMappingURL=eslint-plugin-readability-rules.js.map