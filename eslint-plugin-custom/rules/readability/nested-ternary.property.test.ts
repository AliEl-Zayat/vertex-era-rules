...
describe('Property Tests: no-nested-ternary', () => {
	it('Property 11: Nested ternary detection', () => {
		/**
		 * Feature: additional-eslint-rules, Property 11: Nested ternary detection
		 * For any ternary operator, the rule should report an error if and only if its consequent
		 * or alternate branches contain another ternary operator (including those within parentheses)
	...
	it('Property 12: Independent ternary exemption', () => {
		/**
		 * Feature: additional-eslint-rules, Property 12: Independent ternary exemption
		 * For any code containing multiple ternary operators at the same level without nesting,
		 * the rule should not report errors
		 * Validates: Requirements 4.3
		 */

		// Generator for variable names (not used in this test but kept for consistency)
		const varNameGen = createVarNameGen();
