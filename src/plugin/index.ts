 ...
 * - JSX: no-inline-objects, no-inline-functions, react-node-prop-naming, jsx-element-component-mismatch
...
const rules = {
	...
	'react-node-prop-naming': jsxRules['react-node-prop-naming'],
	'jsx-element-component-mismatch': jsxRules['jsx-element-component-mismatch'],
	// Naming rules
	...
	configs: {
		recommended: {
			rules: {
				...
				'custom/react-node-prop-naming': 'error',
				'custom/jsx-element-component-mismatch': 'error',
